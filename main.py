...
app.config['JWT_SECRET_KEY'] = 'your_jwt_secret_key'  # Should be in environment variable in production

# User database (in-memory for demo, replace with actual database in production)
users_db = {}
...
def login_page():
    if request.method == 'POST':
        ...
        if username == 'admin' and password == 'password':
            ...
            return redirect('/index.html')  # Direct URL redirection
...
# API endpoint for login - separate from form-based login
...
# Home page route for the main application page
@app.route('/home')
def home_page():
